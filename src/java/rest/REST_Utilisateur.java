 ...
 * [entites.utilisateur]<br>
 * USAGE:
 * <pre>
 *        REST_Utilisateur client = new REST_Utilisateur();
...
public class REST_Utilisateur {
    ...
    public <T> T verifier(Class<T> responseType, String login, String password) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("verifier/{0}/{1}", new Object[]{login, password}));
